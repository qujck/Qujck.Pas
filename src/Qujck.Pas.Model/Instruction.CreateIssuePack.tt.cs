...
{
    [Serializable]
    public sealed partial class CreateIssuePack : AbstractInstructionEntity, IReferenceContract
    {
        internal CreateIssuePackDo initialValues { get; private set; }
        internal CreateIssuePackDo updatedValues { get; private set; }
        internal Action<CreateIssuePackDo, string> loadMissingValue { private get; set; }

        public CreateIssuePack()
        {
            this.initialValues = new CreateIssuePackDo();
            this.updatedValues = new CreateIssuePackDo();
