...
{
    [Serializable]
    public sealed partial class ProcessRiskCoverCharge : AbstractInstructionEntity, IReferenceContract
    {
        internal ProcessRiskCoverChargeDo initialValues { get; private set; }
        internal ProcessRiskCoverChargeDo updatedValues { get; private set; }
        internal Action<ProcessRiskCoverChargeDo, string> loadMissingValue { private get; set; }

        public ProcessRiskCoverCharge()
        {
            this.initialValues = new ProcessRiskCoverChargeDo();
            this.updatedValues = new ProcessRiskCoverChargeDo();
        ...
        public override void Deserialize(IQueryable<XElement> elements)
        {
            ...
            XElement e2 = elements.FirstOrDefault(x => x.Name == "RiskCover_id");
            if (e2 != null)
            {
                this.RiskCover_id = long.Parse(e2.Value);
            }
