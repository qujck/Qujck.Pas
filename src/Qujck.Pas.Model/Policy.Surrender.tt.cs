...
{
    [Serializable]
    public sealed partial class Surrender : AbstractPolicyEntity
    {
        internal SurrenderDo initialValues { get; private set; }
        internal SurrenderDo updatedValues { get; private set; }
        internal Action<SurrenderDo, string> loadMissingValue { private get; set; }

        public Surrender()
        {
            this.initialValues = new SurrenderDo();
            this.updatedValues = new SurrenderDo();
        ...
        public override void Deserialize(IQueryable<XElement> elements)
        {
            ...
            XElement e4 = elements.FirstOrDefault(x => x.Name == "payee");
            if (e4 != null) 
            {
                this.payee = e4.Value;
            }

            XElement e5 = elements.FirstOrDefault(x => x.Name == "FinancialInstitutionAccount_id");
            if (e5 != null)
            {
                this.FinancialInstitutionAccount_id = long.Parse(e5.Value);
            }

            XElement e6 = elements.FirstOrDefault(x => x.Name == "Contract_id");
            if (e6 != null)
            {
                this.Contract_id = long.Parse(e6.Value);
            }
