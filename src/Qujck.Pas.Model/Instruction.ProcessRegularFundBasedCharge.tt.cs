...
{
    [Serializable]
    public sealed partial class ProcessRegularFundBasedCharge : AbstractInstructionEntity, IReferenceContract
    {
        internal ProcessRegularFundBasedChargeDo initialValues { get; private set; }
        internal ProcessRegularFundBasedChargeDo updatedValues { get; private set; }
        internal Action<ProcessRegularFundBasedChargeDo, string> loadMissingValue { private get; set; }

        public ProcessRegularFundBasedCharge()
        {
            this.initialValues = new ProcessRegularFundBasedChargeDo();
            this.updatedValues = new ProcessRegularFundBasedChargeDo();
        ...
        internal override string table
        {
            get
            {
                return "ProcessRegularFundBasedCharge";
            }
        }
