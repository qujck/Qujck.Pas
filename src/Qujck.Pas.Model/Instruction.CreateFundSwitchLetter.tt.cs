...
{
    [Serializable]
    public sealed partial class CreateFundSwitchLetter : AbstractInstructionEntity, IReferenceContract
    {
        internal CreateFundSwitchLetterDo initialValues { get; private set; }
        internal CreateFundSwitchLetterDo updatedValues { get; private set; }
        internal Action<CreateFundSwitchLetterDo, string> loadMissingValue { private get; set; }

        public CreateFundSwitchLetter()
        {
            this.initialValues = new CreateFundSwitchLetterDo();
            this.updatedValues = new CreateFundSwitchLetterDo();
        ...
        public override void Deserialize(IQueryable<XElement> elements)
        {
            ...
            XElement e2 = elements.FirstOrDefault(x => x.Name == "FundSwitchHeader_id");
            if (e2 != null)
            {
                this.FundSwitchHeader_id = long.Parse(e2.Value);
            }
