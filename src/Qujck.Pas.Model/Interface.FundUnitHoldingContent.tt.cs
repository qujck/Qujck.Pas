...
{
    [Serializable]
    public sealed partial class FundUnitHoldingContent : AbstractInterfaceEntity
    {
        internal FundUnitHoldingContentDo initialValues { get; private set; }
        internal FundUnitHoldingContentDo updatedValues { get; private set; }
        internal Action<FundUnitHoldingContentDo, string> loadMissingValue { private get; set; }

        public FundUnitHoldingContent()
        {
            this.initialValues = new FundUnitHoldingContentDo();
            this.updatedValues = new FundUnitHoldingContentDo();
