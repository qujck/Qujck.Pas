...
{
    [Serializable]
    public sealed partial class SecurityUser : AbstractSecurityEntity, ICode
    {
        internal SecurityUserDo initialValues { get; private set; }
        internal SecurityUserDo updatedValues { get; private set; }
        internal Action<SecurityUserDo, string> loadMissingValue { private get; set; }

        public SecurityUser()
        {
            this.initialValues = new SecurityUserDo();
            this.updatedValues = new SecurityUserDo();
