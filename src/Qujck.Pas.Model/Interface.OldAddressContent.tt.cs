...
{
    [Serializable]
    public sealed partial class OldAddressContent : AbstractInterfaceEntity
    {
        internal OldAddressContentDo initialValues { get; private set; }
        internal OldAddressContentDo updatedValues { get; private set; }
        internal Action<OldAddressContentDo, string> loadMissingValue { private get; set; }

        public OldAddressContent()
        {
            this.initialValues = new OldAddressContentDo();
            this.updatedValues = new OldAddressContentDo();
