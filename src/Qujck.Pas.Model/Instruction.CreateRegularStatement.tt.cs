...
{
    [Serializable]
    public sealed partial class CreateRegularStatement : AbstractInstructionEntity, IReferenceContract
    {
        internal CreateRegularStatementDo initialValues { get; private set; }
        internal CreateRegularStatementDo updatedValues { get; private set; }
        internal Action<CreateRegularStatementDo, string> loadMissingValue { private get; set; }

        public CreateRegularStatement()
        {
            this.initialValues = new CreateRegularStatementDo();
            this.updatedValues = new CreateRegularStatementDo();
        ...
        public override void Deserialize(IQueryable<XElement> elements)
        {
            ...
            XElement e2 = elements.FirstOrDefault(x => x.Name == "nextStatementDate");
            if (e2 != null)
            {
                this.nextStatementDate = System.DateTime.Parse(e2.Value);
            }
        ...
        public override void WriteXml(System.Xml.XmlWriter writer)
        {
            ...
            else if (this.initialValues.nextStatementDateHasValue)
            {
