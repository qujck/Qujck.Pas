...
{
    [Serializable]
    public sealed partial class CreateNtuLetter : AbstractInstructionEntity, IReferenceContract
    {
        internal CreateNtuLetterDo initialValues { get; private set; }
        internal CreateNtuLetterDo updatedValues { get; private set; }
        internal Action<CreateNtuLetterDo, string> loadMissingValue { private get; set; }

        public CreateNtuLetter()
        {
            this.initialValues = new CreateNtuLetterDo();
            this.updatedValues = new CreateNtuLetterDo();
