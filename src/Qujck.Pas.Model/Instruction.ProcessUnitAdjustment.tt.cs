...
{
    [Serializable]
    public sealed partial class ProcessUnitAdjustment : AbstractInstructionEntity, IReferenceContract
    {
        internal ProcessUnitAdjustmentDo initialValues { get; private set; }
        internal ProcessUnitAdjustmentDo updatedValues { get; private set; }
        internal Action<ProcessUnitAdjustmentDo, string> loadMissingValue { private get; set; }

        public ProcessUnitAdjustment()
        {
            this.initialValues = new ProcessUnitAdjustmentDo();
            this.updatedValues = new ProcessUnitAdjustmentDo();
        ...
        public override void Deserialize(IQueryable<XElement> elements)
        {
            ...
            XElement e3 = elements.FirstOrDefault(x => x.Name == "UnitAdjustmentHeader_id");
            if (e3 != null)
            {
                this.UnitAdjustmentHeader_id = long.Parse(e3.Value);
            }
