...
{
    [Serializable]
    public sealed partial class ProcessRegularWithdrawal : AbstractInstructionEntity, IReferenceContract
    {
        internal ProcessRegularWithdrawalDo initialValues { get; private set; }
        internal ProcessRegularWithdrawalDo updatedValues { get; private set; }
        internal Action<ProcessRegularWithdrawalDo, string> loadMissingValue { private get; set; }

        public ProcessRegularWithdrawal()
        {
            this.initialValues = new ProcessRegularWithdrawalDo();
            this.updatedValues = new ProcessRegularWithdrawalDo();
        ...
        internal override string table
        {
            get
            {
                return "ProcessRegularWithdrawal";
            }
        }
