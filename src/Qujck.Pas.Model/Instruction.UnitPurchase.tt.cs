...
{
    [Serializable]
    public sealed partial class UnitPurchase : AbstractInstructionEntity, IReferenceContract
    {
        internal UnitPurchaseDo initialValues { get; private set; }
        internal UnitPurchaseDo updatedValues { get; private set; }
        internal Action<UnitPurchaseDo, string> loadMissingValue { private get; set; }

        public UnitPurchase()
        {
            this.initialValues = new UnitPurchaseDo();
            this.updatedValues = new UnitPurchaseDo();
