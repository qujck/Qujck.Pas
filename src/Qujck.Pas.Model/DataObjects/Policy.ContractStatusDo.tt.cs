...
{
    [Serializable]
    internal sealed partial class ContractStatusDo : AbstractModel
    {
        internal ContractStatusDo() 
        {
            this.statusValue = new ContractState();
        }
        
        public bool statusHasValue { get; internal set; }
        private ContractState statusValue  { get; set; }
