...
{
    [Serializable]
    internal sealed partial class ProcessTopUpDo : AbstractModel
    {
        internal ProcessTopUpDo() 
        {
        }
        
        public bool TopUp_idHasValue { get; internal set; }
        private long TopUp_idValue  { get; set; }
        public long TopUp_id 
        {
            get
            {
                return this.TopUp_idValue;
            }
            internal set
            {
                this.TopUp_idHasValue = true;
                this.TopUp_idValue = value;
            }
        }
