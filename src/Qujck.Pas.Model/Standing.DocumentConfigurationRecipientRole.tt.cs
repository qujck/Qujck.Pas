...
{
    [Serializable]
    public sealed partial class DocumentConfigurationRecipientRole : AbstractStandingEntity
    {
        internal DocumentConfigurationRecipientRoleDo initialValues { get; private set; }
        internal DocumentConfigurationRecipientRoleDo updatedValues { get; private set; }
        internal Action<DocumentConfigurationRecipientRoleDo, string> loadMissingValue { private get; set; }

        public DocumentConfigurationRecipientRole()
        {
            this.initialValues = new DocumentConfigurationRecipientRoleDo();
            this.updatedValues = new DocumentConfigurationRecipientRoleDo();
        ...
        internal override string table
        {
            get
            {
                return "DocumentConfigurationRecipientRole";
            }
        }
