...
{
    [Serializable]
    public sealed partial class ProcessEscalation : AbstractInstructionEntity, IReferenceContract
    {
        internal ProcessEscalationDo initialValues { get; private set; }
        internal ProcessEscalationDo updatedValues { get; private set; }
        internal Action<ProcessEscalationDo, string> loadMissingValue { private get; set; }

        public ProcessEscalation()
        {
            this.initialValues = new ProcessEscalationDo();
            this.updatedValues = new ProcessEscalationDo();
        ...
        internal override IEnumerable<string> columns
        {
            ...
            {
                yield return "id";
                yield return "NewInvestmentBenefit_id";
        ...
        [XmlElement(ElementName="NewInvestmentBenefit_id")]
        public long? NewInvestmentBenefit_id 
	    { 
            get
            {
                if (this.updatedValues.NewInvestmentBenefit_idHasValue)
                {
                    return this.updatedValues.NewInvestmentBenefit_id;
                }
                
                if (!this.initialValues.NewInvestmentBenefit_idHasValue)
                {
                    this.loadMissingValue(this.initialValues, "NewInvestmentBenefit_id");
                    this.initialValues.NewInvestmentBenefit_idHasValue = true;
                }

                return this.initialValues.NewInvestmentBenefit_id;
            }
            set
            {
                this.updatedValues.NewInvestmentBenefit_id = value;
            }
        }
        ...
        public override void Deserialize(IQueryable<XElement> elements)
        {
            ...
            XElement e2 = elements.FirstOrDefault(x => x.Name == "NewInvestmentBenefit_id");
            if (e2 != null)
            {
                this.NewInvestmentBenefit_id = long.Parse(e2.Value);
            }
        ...
        public override void WriteXml(System.Xml.XmlWriter writer)
        {
            ...
            if (this.updatedValues.NewInvestmentBenefit_idHasValue && NewInvestmentBenefit_id != null)
            {
                writer.WriteElementString("NewInvestmentBenefit_id", this.updatedValues.NewInvestmentBenefit_id.ToString());
            }
            else if (this.initialValues.NewInvestmentBenefit_idHasValue && NewInvestmentBenefit_id != null)
            {
                writer.WriteElementString("NewInvestmentBenefit_id", this.initialValues.NewInvestmentBenefit_id.ToString());
            }
