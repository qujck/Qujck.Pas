...
{
    [Serializable]
    public sealed partial class CreateSurrenderLetter : AbstractInstructionEntity, IReferenceContract
    {
        internal CreateSurrenderLetterDo initialValues { get; private set; }
        internal CreateSurrenderLetterDo updatedValues { get; private set; }
        internal Action<CreateSurrenderLetterDo, string> loadMissingValue { private get; set; }

        public CreateSurrenderLetter()
        {
            this.initialValues = new CreateSurrenderLetterDo();
            this.updatedValues = new CreateSurrenderLetterDo();
