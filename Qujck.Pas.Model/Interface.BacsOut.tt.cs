...
{
    [Serializable]
    public sealed partial class BacsOut : AbstractInterfaceEntity
    {
        internal BacsOutDo initialValues { get; private set; }
        internal BacsOutDo updatedValues { get; private set; }
        internal Action<BacsOutDo, string> loadMissingValue { private get; set; }

        public BacsOut()
        {
            this.initialValues = new BacsOutDo();
            this.updatedValues = new BacsOutDo();
