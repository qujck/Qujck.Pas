...
{
    [Serializable]
    public sealed partial class ProcessBilling : AbstractInstructionEntity, IReferenceContract
    {
        internal ProcessBillingDo initialValues { get; private set; }
        internal ProcessBillingDo updatedValues { get; private set; }
        internal Action<ProcessBillingDo, string> loadMissingValue { private get; set; }

        public ProcessBilling()
        {
            this.initialValues = new ProcessBillingDo();
            this.updatedValues = new ProcessBillingDo();
        ...
        public override void Deserialize(IQueryable<XElement> elements)
        {
            ...
            XElement e2 = elements.FirstOrDefault(x => x.Name == "Billing_id");
            if (e2 != null)
            {
                this.Billing_id = long.Parse(e2.Value);
            }
