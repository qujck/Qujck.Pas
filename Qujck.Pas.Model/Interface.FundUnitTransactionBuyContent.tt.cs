...
{
    [Serializable]
    public sealed partial class FundUnitTransactionBuyContent : AbstractInterfaceEntity
    {
        internal FundUnitTransactionBuyContentDo initialValues { get; private set; }
        internal FundUnitTransactionBuyContentDo updatedValues { get; private set; }
        internal Action<FundUnitTransactionBuyContentDo, string> loadMissingValue { private get; set; }

        public FundUnitTransactionBuyContent()
        {
            this.initialValues = new FundUnitTransactionBuyContentDo();
            this.updatedValues = new FundUnitTransactionBuyContentDo();
        ...
        internal override string table
        {
            get
            {
                return "FundUnitTransactionBuyContent";
            }
        }
