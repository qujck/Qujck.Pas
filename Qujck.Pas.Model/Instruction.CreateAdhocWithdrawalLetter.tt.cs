...
{
    [Serializable]
    public sealed partial class CreateAdhocWithdrawalLetter : AbstractInstructionEntity, IReferenceContract
    {
        internal CreateAdhocWithdrawalLetterDo initialValues { get; private set; }
        internal CreateAdhocWithdrawalLetterDo updatedValues { get; private set; }
        internal Action<CreateAdhocWithdrawalLetterDo, string> loadMissingValue { private get; set; }

        public CreateAdhocWithdrawalLetter()
        {
            this.initialValues = new CreateAdhocWithdrawalLetterDo();
            this.updatedValues = new CreateAdhocWithdrawalLetterDo();
        ...
        internal override string table
        {
            get
            {
                return "CreateAdhocWithdrawalLetter";
            }
        }
        ...
        public override void Deserialize(IQueryable<XElement> elements)
        {
            ...
            XElement e2 = elements.FirstOrDefault(x => x.Name == "AdhocWithdrawalHeader_id");
            if (e2 != null)
            {
                this.AdhocWithdrawalHeader_id = long.Parse(e2.Value);
            }
