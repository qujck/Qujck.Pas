...
{
    [Serializable]
    internal sealed partial class AdhocWithdrawalHeaderDo : AbstractModel
    {
        internal AdhocWithdrawalHeaderDo() 
        {
            this.basisValue = new FundWithdrawalBasis();
        ...
        private FundWithdrawalBasis basisValue  { get; set; }
