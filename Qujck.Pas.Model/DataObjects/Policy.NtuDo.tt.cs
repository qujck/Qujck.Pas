...
{
    [Serializable]
    internal sealed partial class NtuDo : AbstractModel
    {
        internal NtuDo() 
        {
            this.waiveShortfallValue = new Indicator();
        ...
        public bool waiveShortfallHasValue { get; internal set; }
        private Indicator waiveShortfallValue  { get; set; }
        public Indicator waiveShortfall 
        {
            get
            {
                return this.waiveShortfallValue;
            }
            internal set
            {
                this.waiveShortfallHasValue = true;
                this.waiveShortfallValue = value;
            }
        }
